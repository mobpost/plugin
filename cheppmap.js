...
function displayToc(filter) {
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="chepp-map">Menampilkan total ' + postTitle.length + ' article<br/></span>'; }
   else {
      var tocNote = '<span class="chepp-map">Menampilkan ' + numDisplayed + ' artikel dengan label \'';
